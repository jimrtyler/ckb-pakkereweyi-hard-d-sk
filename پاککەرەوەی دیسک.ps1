...
#GUI Variables
$FormTitleText = "پاککەرەوەی دیسک لەلایەن جیم تایلەر (PowerShellEngineer.com)"
$SelectDiskLabelText = "دیسک هەڵبژێرە:"
$FreeSpaceLabelText = "شوێنی ئازاد (گیگابایت): "
$TotalSpaceLabelText = "کۆی گشتی شوێن (گیگابایت): "
$JunkFoundLabelText = "بابەتی دۆزرایەوە (گیگابایت):"
$CleanDiskBtnText = "پاککردنەوەی دیسک *سڕینەوەی فایلەکان*"
$SpaceCleanedLabelText = "شوێنی پاککراوە (گیگابایت): "
$LogFileLabelText = "پەڕگەی لۆگ دۆزرایەوە: $abcdefg".
$CreditLabelText = "سکریپت لەلایەن جیم تایلەر - PowerShellEngineer.com"
$LogFileLocatedText = "پەڕگەی لۆگ دۆزرایەوە".
$AnalyzingDriveText = "شیکاریکردنی درایوەکان..."
$BrowsersAreRunningText = "گەڕانەکان کاردەکەن... بەکارهێنەر ئاگادار بکەرەوە..."
$PleaseCloseBrowsersText = "تکایە هەموو وێبگەڕەکان دابخە و هەوڵبدەرەوە."
$CleaningDriveText = "پاککردنەوەی درایو..."
